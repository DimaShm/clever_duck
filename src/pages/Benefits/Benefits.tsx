    ...
    <div className="Benefits">
      <section className="Benefits__about">
        ...
        <p className="text Benefits__text Benefits__text--about">
          На жаль, дослідження показують, що більшість власників собак не дотримуються вказівок FDA щодо кормів для домашніх тварин через брак часу, зусиль чи обізнаності. Їх впровадження можуть значно зменшити випадки бактеріальних захворювань та зараження собак.
          <br />  <br />
